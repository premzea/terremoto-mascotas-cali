...
_TEAM_MODE=$(~/.gstack/bin/gstack-config get team_mode 2>/dev/null || echo "false")
...
```bash
~/.gstack/bin/gstack-update-check --force 2>/dev/null || \
