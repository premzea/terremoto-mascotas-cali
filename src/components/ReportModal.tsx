  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      const petPayload: PetReport = {
        ...
        lat: selectedLat !== undefined ? selectedLat : (barrioCoords as any)[(neighborhood || barrioSearch).toLowerCase()]?.lat || 3.4516,
        lng: selectedLng !== undefined ? selectedLng : (barrioCoords as any)[(neighborhood || barrioSearch).toLowerCase()]?.lng || -76.532,
